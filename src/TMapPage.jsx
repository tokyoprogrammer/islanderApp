...
export default class TmapView extends React.Component {
  ...
  loadMap() {
    ...
    var tmapLatLng = JSON.parse(localStorage.getItem("tmapLatLng"));
    ...
    var marker_s = new Tmap.Marker(new Tmap.LonLat(
      "126.9850380932383", "37.566567545861645").transform("EPSG:4326", "EPSG:3857"), icon);
    ...
    var marker_e = new Tmap.Marker(new Tmap.LonLat(
      "127.10331814639885", "37.403049076341794").transform("EPSG:4326", "EPSG:3857"), icon);
    //설정한 좌표를 "EPSG:3857"로 좌표변환한 좌표값으로 설정합니다.
